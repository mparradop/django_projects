...
class Country(models.Model):
    ...
    country_name = models.CharField(100,max_length=100)
    CCTLD = models.CharField(20,max_length=100)


class Industry(models.Model):
    industry_name = models.CharField(50,max_length=100)


class Company(models.Model):
    company_name = models.CharField(50,max_length=100)
    domain = models.CharField(50,max_length=100)
    address = models.CharField(100,max_length=100)
...
class Category(models.Model):
    ...
    category_name = models.CharField(50,max_length=100)
    category_code = models.CharField(50,max_length=100)
    description = models.CharField(100,max_length=100)


class Status(models.Model):
    id_status = models.AutoField(primary_key=True, db_index=True)
    status_name = models.CharField(50,max_length=100)
    description = models.CharField(100,max_length=100)

class Flag(models.Model):
    id_flag = models.AutoField(primary_key=True, db_index=True)
    flag_name = models.CharField(50,max_length=100)
    description = models.CharField(100,max_length=100)

class Source(models.Model):
    id_source = models.AutoField(primary_key=True, db_index=True)
    source_name = models.CharField(50,max_length=100)
    description = models.CharField(100,max_length=100)

class Risk(models.Model):
    id_risk = models.AutoField(primary_key=True, db_index=True)
    risk_name = models.CharField(50,max_length=100)
    risk_code = models.CharField(50,max_length=100)
    description = models.CharField(100,max_length=100)

class Priority(models.Model):
    id_priority = models.AutoField(primary_key=True, db_index=True)
    priority_name = models.CharField(50,max_length=100)
    priority_code = models.CharField(50,max_length=100)
    description = models.CharField(100,max_length=100)
...
class Employee(models.Model):
    ...
    emp_name = models.CharField(40,max_length=100)
    emp_last_name = models.CharField(50,max_length=100)
    user_name = models.CharField(50,max_length=100)
...
class Org_team(models.Model):
    ...
    team_name = models.CharField(50,max_length=100)
    description = models.CharField(100,max_length=100)
...
class Region(models.Model):
    region_name = models.CharField(30,max_length=100)
    director = models.ForeignKey(Employee, on_delete=models.CASCADE)


class Territory(models.Model):
    territory_name = models.CharField(30,max_length=100)
...
class Product(models.Model):
    ...
    product_name = models.CharField(50,max_length=100)
    product_code = models.CharField(50,max_length=100)
